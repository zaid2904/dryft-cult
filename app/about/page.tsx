...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-black text-white font-mono selection:bg-white selection:text-black overflow-x-hidden">
      ...
      {/* Editorial Hero */}
      <section className="relative h-[70vh] sm:h-[80vh] min-h-[500px] sm:min-h-[600px] w-full flex items-end pb-12 sm:pb-16 px-4 sm:px-6 md:px-12 border-b border-white/10 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1800px] w-full mx-auto space-y-3 sm:space-y-4">
          <span className="text-[10px] sm:text-xs text-neutral-500 tracking-[0.25em] sm:tracking-[0.3em] uppercase block">
            // CULT MANIFESTO
          </span>
          <h1 className="fluid-hero-title font-black tracking-tighter uppercase leading-none max-w-5xl">
      ...
      <section className="py-16 sm:py-24 md:py-36 px-4 sm:px-6 md:px-12 border-b border-white/10 max-w-[1800px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-center">
          <div className="lg:col-span-5 space-y-4 sm:space-y-6">
            ...
            <p className="text-xs sm:text-sm text-neutral-400 leading-relaxed tracking-wider">
          ...
          <div className="lg:col-span-7 grid grid-cols-2 gap-3 sm:gap-4">
            ...
            <div className="relative aspect-[3/4] bg-neutral-900 border border-white/10 overflow-hidden translate-y-0 sm:translate-y-8">
              <Image
      ...
      <section className="py-16 sm:py-24 md:py-36 px-4 sm:px-6 md:px-12 bg-neutral-950 border-b border-white/10">
        <div className="max-w-[1800px] mx-auto space-y-10 sm:space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="p-6 sm:p-8 bg-black border border-white/10 space-y-4 hover:border-white/40 transition-colors">
              <span className="text-xs text-neutral-500 font-mono">01 // STRUCTURAL INTEGRITY</span>
              <h3 className="text-lg sm:text-xl font-bold uppercase tracking-tight">450+ GSM ARCHITECTURE</h3>
            ...
            <div className="p-6 sm:p-8 bg-black border border-white/10 space-y-4 hover:border-white/40 transition-colors">
              ...
              <h3 className="text-lg sm:text-xl font-bold uppercase tracking-tight">LIMITED SERIALIZED DROPS</h3>
              <p className="text-xs text-neutral-400 leading-relaxed">
            ...
            <div className="p-6 sm:p-8 bg-black border border-white/10 space-y-4 hover:border-white/40 transition-colors">
              ...
              <h3 className="text-lg sm:text-xl font-bold uppercase tracking-tight">LESS UI. MORE BRAND.</h3>
              <p className="text-xs text-neutral-400 leading-relaxed">
      ...
      <section className="py-20 sm:py-28 md:py-40 px-4 sm:px-6 md:px-12 text-center max-w-5xl mx-auto space-y-6 sm:space-y-8">
        <h2 className="fluid-subheading font-black uppercase tracking-tighter leading-tight">
        ...
        <div className="pt-4 sm:pt-6">
          <Link
            href="/shop"
            className="inline-flex items-center justify-center gap-3 bg-white text-black px-8 py-4 text-xs font-bold tracking-widest uppercase hover:bg-neutral-200 transition-colors min-h-[48px] w-full sm:w-auto"
          >
